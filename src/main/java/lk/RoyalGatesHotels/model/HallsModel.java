...
public class HallsModel {
    ...
    public static boolean addHall(HallDTO hall) throws SQLException, ClassNotFoundException {
    ...
    public static boolean updateHall(HallDTO hall) throws SQLException, ClassNotFoundException {
